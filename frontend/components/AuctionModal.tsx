...
export const AuctionModal = () => {
  ...
  useEffect(() => {
    if (auction) {
      ...
      setQuickBidAmount(auction.current_bid + 100);
      setTimeLeft(auction.time_remaining || 30);
    }
  }, [auction?.current_bid]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-3xl font-bold text-green-400">₹{auction.current_bid}</p>
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-3xl font-bold text-success-400">₹{myMoney}</p>
              </div>
          ...
          {amIParticipating ? (
            ...
            >
                  ...
                  {quickBidOptions.map(amount => (
                    ...
                    >
                      <div className="text-center">
                        <div className="text-lg font-bold text-primary-300">+₹{amount}</div>
                        <div className="text-xs text-text-muted">Total: ₹{auction.current_bid + amount}</div>
                      </div>
                    </motion.button>
                  ))}
                </div>
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex justify-between mt-2">
                      <span className="text-xs text-text-muted">Min: ₹{auction.current_bid + 1}</span>
                      <span className="text-xs text-text-muted">Your max: ₹{myMoney}</span>
                    </div>
                  </div>
              ...
              <div className="flex gap-4 pt-6 border-t border-white/10">
                ...
                <motion.button
                  onClick={() => setBidAmount(auction.current_bid + 100)}
