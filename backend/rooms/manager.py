...
class RoomManager:
    ...
    def create_room(self, host_id: str, host_name: str, host_color: str) -> str:
    ...
    def join_room(self, room_code: str, player_id: str, player_name: str, player_color: str) -> Optional[RoomState]:
